...
import com.galaxy.demo.Constant.Constant;
import com.galaxy.demo.exceptions.JsonDeserializedException;
import com.galaxy.demo.exceptions.JsonSerializedException;
...
public class JsonBinderUtil {
    ...
    private static JsonBinderUtil instance = new JsonBinderUtil(JsonInclude.Include.NON_EMPTY);

    private static ObjectMapper mapper;

    private JsonBinderUtil(JsonInclude.Include include) {
...
//	}
    ...
    public static <T> T fromJsontolist(String jsonString, TypeReference<T> typeReference) {
        ...
        try {
            ...
            mapper.setDateFormat(new SimpleDateFormat(Constant.DATE_PATTERN));
            return mapper.readValue(jsonString,typeReference);
        } catch (IOException e) {
            e.printStackTrace();

            try{
                mapper.setDateFormat(new SimpleDateFormat(Constant.DATE_PATTERN_YMD));
                return mapper.readValue(jsonString,typeReference);
